...
namespace DiplomGames
{
    public class ObjectPoolMono<T> where T : MonoBehaviour
    {
        ...
        public ObjectPoolMono(T obj, int sizePool, Transform parentContainer, bool autoExpend = false)
        {
            this.obj = obj;
        ...
        public ObjectPoolMono(T obj, int sizePool, bool autoExpend = false)
        {
            this.obj = obj;
            this.container = null;
            this.sizePool = sizePool;
